...
const PAIRS = {
  mentee: [
    ...
    {key:"player",    label:"Video playback",note:'Controls on frosted discs and a title with its own scrim, so <b>the player reads the same over any frame</b>.'},
  ...
  mentor: [
    ...
    {key:"mentees",   label:"Mentees",       note:'Roster, capacity and requests in one place. <b>Each mentee&rsquo;s industry reads off the glyph and their milestone progress off the bar</b>.'},
...
const NEW = [
  {key:"conversations",   title:"Conversations",    status:"#ece6df", note:"A direct thread with your mentor."},
  {key:"pulse-ai",        title:"Pulse AI",         status:"#f6f2ff", note:"An AI career coach inside the app."},
  {key:"career-timeline", title:"Career Timeline",  status:"#ece6df", note:"Education, experience and goals in one record."},
  {key:"pathway-discover",title:"Pathway Discover", status:"#ece6df", note:"Pathways ranked from what a student has told P3."},
  {key:"dark-mode",       title:"Dark mode",        status:"#141020", note:"A night palette for the whole app, one tap from Profile."},
];
    ...
    <div class="shotwrap">
      <button class="zoomwrap" data-mode="single" data-key="${item.key}" data-label="${item.title}"
        ...
        <div class="device" style="--status:${item.status}">
          <span class="zbadge" aria-hidden="true">&#10530;</span>
          <div class="device-screen"><div class="device-status" aria-hidden="true"></div><img src="https://tparis7.github.io/P3-Mobile-App-Redesign/assets/shots/new/${item.key}.webp" alt="${item.title}"
