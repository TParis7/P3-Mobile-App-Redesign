...
const NEW = [
  {key:"conversations",   title:"Conversations",    status:"#ece6df", note:"A direct thread with your mentor: share a scholarship, ask a question, keep the answer."},
  {key:"pulse-ai",        title:"Pulse AI",         status:"#f6f2ff", note:"An AI career coach inside the app. It opens with somewhere to start, not a blank box."},
  {key:"career-timeline", title:"Career Timeline",  status:"#ece6df", note:"Education, experience and goals as one record the student owns and a mentor can read."},
  {key:"pathway-discover",title:"Pathway Discover", status:"#ece6df", note:"Pathways ranked from what a student has already told P3, surfaced on Home as Find your pathway."},
  {key:"dark-mode",       title:"Dark mode",        status:"#141020", note:"A night palette for the whole app, one tap from Profile. Crimson and violet stay as the accents; the Ascent turns to twilight."},
];
