...
const PAIRS = {
  ...
  mentor: [
    ...
    {key:"mentees",   label:"Mentees",       note:'Roster, capacity and requests in one place, with <b>each mentee&rsquo;s field and milestone progress at a glance</b>.'},
...
const NEW = [
  ...
  {key:"career-timeline", title:"Career Timeline",  status:"#ece6df"},
  {key:"pathway-discover",title:"Career Navigator", status:"#ece6df"},
